...
if(isset($_POST['done']))
{
    ...
    if(!empty($quest) || !empty($opt1) || !empty($opt3) || !empty($opt4) || !empty($ans) )
    {
        $upt = "UPDATE multiple_choice SET question='$quest',option1 = '$opt1',option2= '$opt2',option3 = '$opt3',option4 = '$opt4',answer='$ans' WHERE id ='$id' ";
          ...
          <div class="col-lg-6">
            ...
            <form  role="form" id="formLogin" novalidate="" method="POST" action="">
              ...
              <div class="form-group">
                ...
                <input class="form-control" name="opt1" id="opt1" placeholder="Enter First option">
              </div>

              <div class="form-group">
                <label>option 2</label>
                <input class="form-control" name="opt2" id="opt2" placeholder="Enter Second option">
              </div>

              <div class="form-group">
                <label>option 3</label>
                <input class="form-control" name="opt3" id="opt3" placeholder="Enter Third option">
              </div>

              <div class="form-group">
                <label>option 4</label>
                <input class="form-control" name="opt4" id="opt4" placeholder="Enter Forth option">
              </div>
              <div class="form-group">
                <label>answer </label>
