        ...
        <div class="collapse navbar-collapse navbar-ex1-collapse">
         ...
         <li class="dropdown">
              ...
              <ul class="dropdown-menu">
                <li><a href="#">Create Queation Papers</a></li>
          ...
          <div class="col-lg-6">
            ...
            <form target="" role="form" id="formLogin" novalidate="" method="POST" action="">
                    <br>
                    <br>
                    <br>
            
                        <label style="margin-left:300;">UPDATE USER PICTURE</label><br>
						<br>
						<br>
						
						<?php
						    $output = mysqli_query($con,"SELECT * FROM users WHERE email = '$email' ");
                            while($line = mysqli_fetch_array($output))
                              {
                               // $status = $row['status'];
                                ...
                                if($line['status'] == 1)
                                {
                                  echo   "<img style=\"margin-left:300;width:100px;heiht:95px;border-radius:50%;\" src=\"uploads/male.png \" alt=\"profile\"> <br>";
                                }
							                  else{
                                  echo   "<img style=\"margin-left:300;width:100px;heiht:95px;border-radius:50%;\" src=\"uploads/".$image." alt=\"pic\"> <br>";
            ...
            <br>
						...
						<input type="file" name="file" id="file" style="margin-left:300;" >
            <input type="submit" class="btn btn-warning"  name="upload"id="upload" value="upload" style="margin-left:300;"/>
			</form>
